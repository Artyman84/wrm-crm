...
/**
 * Class SearchSuperAdmin
 * @package backend\models\search\users
 */
class SearchSuperAdmin extends UserSearch implements UserSearchInterface
{
    /**
     * @var int
     */
    ...
    public function getColumns(): array
    {
        return [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function(SuperAdmin $model) {
                    if ($model->person->photo) {
            ...
            [
                ...
                'value' => function(SuperAdmin $model) {
                    ...
                    return "<i class='flag-icon flag-icon-$code'></i> {$model->person->country->name}";
                }
            ],
            ...
            [
                ...
                'template' => '{update}',
                'buttons' => [
                    'update' => function(string $url, SuperAdmin $model) {
